...
<?php include("php/header-crud.php"); ?>
 ...
 <div class="title">Registrar Producto</div>
    <div class="content">
        <form id="form1" name="form1" method="POST" action="crear2_producto.php" onsubmit="return validarForm(this);" enctype="multipart/form-data">
        <div class="user-details">
          <div class="input-box">
          <span class="details">  <label for="txt_id">
            </label>Precio del Producto</span>
            <input type="text" name="txt_prec" id="txt_prec" value="" required maxlength="11" placeholder="Precio del producto...">
          </div>
          <div class="input-box">
